...
{\large In the legendary real-time-strategy video game {\em Age of Empires II: The Age of Kings} (as well as \\ \ \\  its various expansion packs), what does the cheat code {\tt howdoyouturnthison} accomplish?}  \myline{.87 in} \\ \ \\ \myline{\textwidth}

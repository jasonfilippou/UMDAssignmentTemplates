...
\newcommand{\ecquestion}[2]{\stepcounter{questions} \noindent{\emph{\Large Question (\alph{questions}): #1 (#2 pts extra credit) }\\[.4cm]}}
\newcommand{\subquestion}[2]{\stepcounter{subquestions} \noindent{\emph{\Large Subquestion (\roman{subquestions}): #1 (#2 pts) }\\[.4cm]}}
\newcommand{\ecproblem}{\stepcounter{problems} {\Large \bf \noindent Problem \arabic{problems}:  General Trivia \emph{(1 pt extra credit)}} \\[.4cm]}

...
\input{../../template/packageimports}
\input{../../template/mymath}
\input{../../template/code}
\input{../../template/formatting}
\input{../../template/emphasis}
\input{../../template/cool}
\input{../../template/homeworkdata}
% \input{../../template/databox} % Edit this file for variable problem numbers in grading box
% \input{../../template/cards}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
